		...
		<StyleWrapper>
			<div>
				...
				<ul>
					...
					<li>
						<p>
							...
							in this Agreement) refers to OpenCareerPortal.
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							<strong>Website</strong> refers to OpenCareerPortal, accessible from{" "}
							<a
								href="https://guarded-tor-41140-5f55c5b2e597.herokuapp.com/"
								rel="external nofollow noopener noreferrer"
								target="_blank"
							>
								https://guarded-tor-41140-5f55c5b2e597.herokuapp.com/
							</a>
						</p>
					</li>
					<li>
				...
				<p>
					...
					mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. You can learn more
					about cookies on{" "}
				...
				<ul>
					<li>By email: macohiho@gmail.com</li>
				</ul>
			</div>
		</StyleWrapper>
	);
